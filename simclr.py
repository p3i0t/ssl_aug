...
from paired_datasets import PairDataset, AugPairDataset
...
def get_color_distortion(s=0.5):  # default 0.5 for cifar10
...
def train(args: DictConfig) -> None:
    ...
    if args.aug:
        ...
        train_transform = transforms.Compose([train_transform, transforms.ToTensor()])
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch >= args.log_interval and epoch % args.log_interval == 0:
            ...
            torch.save(model.state_dict(),
                       'simclr_{}_epoch{}{}.pt'.format(args.backbone, epoch, '_aug' if args.aug else ''))
